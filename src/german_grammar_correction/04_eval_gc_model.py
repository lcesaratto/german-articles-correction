...
wrong_sentence = "Der Baby schreit. Die Mutter gibt den Baby der Schnuller und nimmt es in den Arm. Dann geht der Mutter mit den Baby auf den Arm in der Küche."
